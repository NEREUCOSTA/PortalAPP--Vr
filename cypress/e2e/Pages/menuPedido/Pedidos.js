class Pedidos {
	...
	static selecionaPedidoDaOperadora() {
		cy.get('//*[@id="wrapper"]/div/div/recharge-order-list-operator/div/div/div/div[2]/div/div/div[2]/table/tr[4]/th').contains('BONFIM CARD - ELETRÔNICO - Responsável VT: Evili Braz').click();
